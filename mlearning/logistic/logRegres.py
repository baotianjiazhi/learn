...
def colicTest():
    ...
    trainWeights = stocGradAscent1(array(trainingSet), traingLabels, 500)
    errCount = 0
    numTestVec = 0.0
...
def multiTest():
    ...
    print("after %d iterations the average error rate is : "
          "%f" % (numTests, errSum / float(numTests)))
...
if __name__ == '__main__':
    ...
    multiTest()
    # weights1 = stocGradAscent1(array(dataArr), labelMat, 500)
